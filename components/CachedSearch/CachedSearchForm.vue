<template>
  <div class="">
    <form class="mt-6 grid gap-4 lg:gap-6 w-max-full"
        ...
        <div class="flex flex-row w-fit mx-auto">
          <div
            ...
            <div class="relative flex items-start w-full">
              <FormRadio id="one_way" v-model="formData.searchType"
          ...
          <div
            class="flex items-center gap-x-2.5 py-3 px-4 text-sm font-medium bg-white border text-gray-800 -mt-px -ms-px first:rounded-se-none first:rounded-es-lg last:rounded-es-none last:rounded-se-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-white">
            <div class="relative flex items-start w-full">
              <FormRadio id="round_trip" v-model="formData.searchType"
      ...
      <Alert v-show="broadSearch" id="broad-search" class="my-2 text-sm"
        type="warning"
      ...
      <BButtonSolid :variant="broadSearch ? 'warning' : 'primary'" type="submit"
