  ...
  <div class="overflow-auto max-h-screen md:max-h-full">
    <table
      ...
      <thead class="sticky top-0 bg-gray-50 dark:bg-neutral-700">
        <tr>
          <th scope="col"
            class="sticky left-0 px-6 bg-gray-50 py-3 text-xs font-medium text-gray-500 uppercase dark:text-neutral-400">
            {{ $t("filters.Route") }}
          </th>
          <th scope="col"
      ...
      <tbody class="divide-y divide-gray-200 dark:divide-neutral-700 relative">
        <tr v-for="availability in availabilities" :key="availability.ID">
          <td
            class="sticky left-0 bg-gray-50 px-3 py-2 whitespace-nowrap text-sm text-center text-gray-800 dark:text-neutral-200">
          ...
          <td class="px-3 py-2 whitespace-nowrap text-sm">
            <SeatsAeroSearchLink :utm-medium="toolId" cabin="economy"
          ...
          <td class="px-3 py-2 whitespace-nowrap text-sm">
            <SeatsAeroSearchLink :utm-medium="toolId" cabin="premium"
              :source="availability.Source" :date="availability.Date"
              :origin="availability.OriginAirport"
              :destination="availability.DestinationAirport">
          ...
          <td class="px-3 py-2 whitespace-nowrap text-sm">
            <SeatsAeroSearchLink :utm-medium="toolId" cabin="business"
              :source="availability.Source" :date="availability.Date"
              :origin="availability.OriginAirport"
              :destination="availability.DestinationAirport">
          ...
          <td class="px-3 py-2 whitespace-nowrap text-sm">
            <SeatsAeroSearchLink :utm-medium="toolId" cabin="first"
              :source="availability.Source" :date="availability.Date"
              :origin="availability.OriginAirport"
              :destination="availability.DestinationAirport">
